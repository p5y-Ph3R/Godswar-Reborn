...
$qualityProfiles = @{
    shoes = @(0, 8, 18, 28, 40, 54, 74, 100, 140, 200, 230, 260, 295, 330, 370, 410, 455, 500, 550, 600)
    girdle = @(0, 8, 18, 28, 40, 54, 74, 100, 140, 200, 230, 260, 295, 330, 370, 410, 455, 500, 550, 600)
}
$gradeProfiles = @{
    shoes = @(10, 13, 16, 20, 24, 28, 32, 40, 50, 60, 80, 100, 116, 133, 151, 170, 190, 211, 233, 256, 280, 305, 332, 365, 400)
    girdle = @(10, 13, 16, 20, 24, 28, 32, 40, 50, 60, 80, 100, 116, 133, 151, 170, 190, 211, 233, 256, 280, 305, 332, 365, 400)
}
...
$backupRoot = Join-Path (Resolve-Path '.').Path "backups\level135plus-boots-girdle-caps-$timestamp"
