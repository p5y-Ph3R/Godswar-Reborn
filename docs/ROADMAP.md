...
- Active EXP effects are synchronized through native opcode `10120`; custom client statuses `1500` through `1504` identify the VIP tiers and faction-area control.
