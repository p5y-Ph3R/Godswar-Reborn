...
{
    private sealed class ZodiacUpgradeCaptureTransport :
        ...
        ISecureCommandResultTransport
    {
        ...
        public ZodiacUpgradeCaptureTransport()
        {
        ...
        public string RemoteEndPoint =>
            "secure-zodiac-upgrade-handler-check";
            ...
            while (offset < encrypted.Length)
            {
                    ...
                    length > encrypted.Length - offset)
                {
                    throw new InvalidDataException(
                        "Captured Zodiac stream has an invalid frame.");
                }
                packets.Add(
        ...
        public ValueTask SendGameGrantAsync(
            ...
            ValueTask.FromException(
                new InvalidOperationException(
                    "Zodiac checks cannot issue login grants."));
