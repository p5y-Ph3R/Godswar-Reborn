...
{
    private sealed class MoveCaptureTransport :
        ...
        ISecureCommandResultTransport
    {
        ...
        public string RemoteEndPoint =>
            "secure-kit-bag-move-handler-check";
            ...
            while (offset < encrypted.Length)
            {
                    ...
                    length > encrypted.Length - offset)
                {
                    throw new InvalidDataException(
                        "Captured move stream has an invalid frame.");
                }
                packets.Add(
        ...
        public ValueTask SendGameGrantAsync(
            ...
            ValueTask.FromException(
                new InvalidOperationException(
                    "Move checks cannot issue login grants."));
