...
internal sealed class FactionCrierCaptureTransport :
    ...
    ISecureCommandResultTransport
{
    ...
    public FactionCrierCaptureTransport()
    {
    ...
    public string RemoteEndPoint => "secure-faction-crier-check";
        ...
        while (offset < clear.Length)
        {
            ...
            if (length < 4 || length > clear.Length - offset)
            {
                throw new InvalidDataException(
                    "Captured Faction Crier stream has an invalid frame.");
            }
    ...
    public ValueTask SendGameGrantAsync(
        ...
        ValueTask.FromException(
            new InvalidOperationException(
                "Faction Crier checks cannot issue login grants."));
