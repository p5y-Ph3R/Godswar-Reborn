        ...
        string originalRevision)
    {
        ...
        try
        {
            ...
            Check.Equal(
                originalRevision,
                upgraded.Revision,
                "startup advances a valid v2 pointer to the complete v4 release");
            Check.Equal(
                before,
                await ReadRevisionFingerprintAsync(dataSource, v2Revision),
                "v2-to-v4 upgrade leaves the sealed v2 release immutable");
