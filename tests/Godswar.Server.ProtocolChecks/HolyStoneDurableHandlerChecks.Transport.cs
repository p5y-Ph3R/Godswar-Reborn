...
{
    private sealed class HolyStoneCaptureTransport :
        ...
        ISecureCommandResultTransport
    {
        ...
        public HolyStoneCaptureTransport()
        {
        ...
        public string RemoteEndPoint => "secure-holy-stone-check";
            ...
            while (offset < encrypted.Length)
            {
                if (encrypted.Length - offset < 4)
                {
                    throw new InvalidDataException(
                        "Captured Holy Stone stream ends inside a header.");
                }
                ...
                {
                    throw new InvalidDataException(
                        "Captured Holy Stone frame length is invalid.");
                }
                packets.Add(
        ...
        public ValueTask SendGameGrantAsync(
            ...
            ValueTask.FromException(
                new InvalidOperationException(
                    "Holy Stone checks cannot issue login grants."));
