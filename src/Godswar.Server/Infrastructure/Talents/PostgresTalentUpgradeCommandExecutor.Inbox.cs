...
internal sealed partial class PostgresTalentUpgradeCommandExecutor
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return scalar is long auditId && auditId > 0
            ...
            : throw new InvalidDataException(
                "The command audit insert returned no identity.");
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return scalar is long inboxId && inboxId > 0
            ? inboxId
            : throw new InvalidDataException(
                "The command inbox insert returned no identity.");
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidDataException(
                "The command inbox duplicate update was not exact.");
        }
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidDataException(
                "The command inbox conflict update was not exact.");
        }
    }

    private static TalentUpgradeExecutionReceipt
        ValidateStoredResult(StoredInbox stored)
    {
        ...
        {
            throw new InvalidDataException(
                "The stored talent result audit reference is invalid.");
        }
