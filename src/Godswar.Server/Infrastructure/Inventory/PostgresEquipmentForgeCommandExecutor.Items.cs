...
internal sealed partial class PostgresEquipmentForgeCommandExecutor
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var afterState =
            ...
            throw new InvalidDataException(
                "The locked equipment-forge item was not updated exactly once.");
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidDataException(
                "The locked equipment-forge material was not deleted exactly once.");
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        command.Parameters.AddWithValue(
            "orderingPolicy",
            EquipmentForgePersistenceCodec.OrderingPolicy);
        ...
        {
            throw new InvalidDataException(
                "The equipment-forge outbox insert was not exact.");
        }
    }
}
