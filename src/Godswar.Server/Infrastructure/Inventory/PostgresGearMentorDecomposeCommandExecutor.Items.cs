...
internal sealed partial class PostgresGearMentorDecomposeCommandExecutor
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!await reader.ReadAsync(cancellationToken))
        {
            throw new InvalidDataException(
                "The Decompose item insert returned no state.");
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var afterState =
            await command.ExecuteScalarAsync(cancellationToken)
                as string ??
            throw new InvalidDataException(
                "The locked Decompose item was not updated exactly once.");
        return new InventoryMutation(
            locked.ItemInstanceId,
            "update",
            locked.BeforeState,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidDataException(
                "The locked Decompose item was not deleted exactly once.");
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        command.Parameters.AddWithValue(
            "orderingPolicy",
            GearMentorDecomposePersistenceCodec.OrderingPolicy);
        ...
        {
            throw new InvalidDataException(
                "The Decompose outbox insert was not exact.");
        }
    }
