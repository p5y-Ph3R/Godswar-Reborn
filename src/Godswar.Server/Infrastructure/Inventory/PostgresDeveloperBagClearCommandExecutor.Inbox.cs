...
internal sealed partial class PostgresDeveloperBagClearCommandExecutor
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        command.Parameters.AddWithValue(
            "outcomeCode",
            DeveloperBagClearPersistenceCodec.ResultCode);
        command.Parameters.AddWithValue(
            "removedItemCount",
            removedItemCount);
        command.Parameters.AddWithValue(
        ...
        return scalar is long auditId && auditId > 0
            ...
            : throw new InvalidDataException(
                "The bag-clear audit returned no identity.");
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return scalar is long inboxId && inboxId > 0
            ? inboxId
            : throw new InvalidDataException(
                "The bag-clear inbox returned no identity.");
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidDataException(
                "The bag-clear duplicate update was not exact.");
        }
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidDataException(
                "The bag-clear conflict update was not exact.");
        }
    }

    private static DeveloperBagClearExecutionReceipt?
            ...
            CommandEnvelope<DeveloperBagClearCommand> envelope)
    {
        ...
        {
            DeveloperBagClearPersistenceCodec.ValidateEmptyBag(
        ...
        {
            throw new InvalidDataException(
                "The stored bag-clear result code is unsupported.");
        }

        var receipt =
            DeveloperBagClearPersistenceCodec.DecodeAndVerify(
                stored.ResultPayload,
                stored.ResultHash);
        if (!string.Equals(
        ...
        {
            throw new InvalidDataException(
                "The stored bag-clear audit reference is invalid.");
        }
