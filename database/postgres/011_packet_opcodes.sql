...
VALUES
    ...
    (10193, 'C2S', 'GearEnhancerItemSelection', 'items', 'observed', 'Native Gear Mentor item selected/removed notification.', 'Observed 16-byte packet: bag page, page slot, then selected flag in the low byte; remaining three bytes are unstable client scratch data.'),
