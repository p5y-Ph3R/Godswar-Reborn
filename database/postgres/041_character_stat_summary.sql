...
talent_stats AS (
    SELECT
        ct.user_id,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'MaxHP') AS max_hp,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'MaxMP') AS max_mp,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'PhyAttack') AS physical_attack,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'PhyDefend') AS physical_defense,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'MagicAttack') AS magic_attack,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'MagicDefend') AS magic_defense,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'Hit') AS hit,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'Miss') AS dodge,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'FrenzyHit') AS critical,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'FrenzyMiss') AS critical_resistance,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'DamageSorb') AS damage_absorb,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'PhyDamage') AS physical_damage_bonus,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'MagicDamage') AS magic_damage_bonus,
        SUM(ct.rank * CASE WHEN tt.is_percent THEN tt.effect_value * 10000 ELSE tt.effect_value END) FILTER (WHERE tet.key = 'Cure') AS cure_bonus,
